 ...
 * 
 */
@WebServiceClient(name = "WsCuentas", targetNamespace = "http://tempuri.org/", wsdlLocation = "http://localhost:8056/WsCuentas.asmx?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8056/WsCuentas.asmx?wsdl");
